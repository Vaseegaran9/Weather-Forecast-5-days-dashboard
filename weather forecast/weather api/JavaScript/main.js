...
fetch('https://api.openweathermap.org/data/2.5/forecast?q='+newName.value+'&appid=2ed918037f090068f84e34af3c7f21df')
...
function DefaultScreen(){
    document.getElementById("cityInput").defaultValue = "Salem";
    GetInfo();
}
